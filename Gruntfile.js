// Generated on 2023-11-07 using generator-angular 0.16.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    wiredep: {
      src: {
        src: ['<%= yeoman.src %>/topGearMotors/index.html'],
        ignorePath:  /\.\.\//
      },
      test: {
    ...
    useminPrepare: {
      html: '<%= yeoman.src %>/topGearMotors/index.html',
      options: {
        dest: '<%= yeoman.dist %>',
        flow: {
          html: {
